package com.example.inventory_management.configuration;

import com.example.inventory_management.dto.ErrorResponseDto;
...
public class ExceptionHandlerConfiguration extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleException(final ResponseException exception, final HttpServletRequest request) {
